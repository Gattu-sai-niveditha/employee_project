		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee ",
									"targetURL": "#EmployeeProjectemployeeproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"EmployeeProjectemployeeproject-display": {
								"semanticObject": "EmployeeProjectemployeeproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=EmployeeProject.employeeproject",
									"url": sap.ui.require.toUrl("EmployeeProject/employeeproject")
								}
							}
						}
					}
